...
AssetOrNothing::AssetOrNothing(const EquityPricerFactory& factory, const BlackScholesModel& model):m_factory(factory),m_model(model){}

double AssetOrNothing::price() const {
